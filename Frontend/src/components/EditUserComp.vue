<template>
    <div class="container-flex-container">
      ...
      <div class="mb-3">
        <label for="exampleInputUserUrl1" class="form-label">User URL</label>
        <input
          type="text"
          class="form-control"
      ...
      <button @click.prevent="updateUser" class="btn-submit">Submit</button>
    </div>
  </template>
...
export default {
    ...
    methods: {
        editUser(id) {
            this.$store.state.users.find((user) => user.id === id)
          },
